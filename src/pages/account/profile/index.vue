<template>
  <a-spin tip="Just a minute..." :spinning="profileSpinning">
    <a-modal
      ...
      <template #title>
        <div class="d-flex">
          ...
          <p class="fw-bold ms-2">Do you want to update your profile?</p>
        </div>
      </template>
      <!-- <template #footer>
        <div class="me-5">
...
export default defineComponent({
    ...
    const onSubmit = () => {
      formRef.value
        ...
        .then(() => {
          ...
          // console.log('values', accountInfo.value);
        })
        .catch((error) => {
  ...
  methods: {
    ...
    updateInfo() {
      ...
      //   message.error('Resign in to continue!', 3, () => {
      //     location.reload();
      //   });
      // } else {
      //   let accessToken = {
      ...
      //   };
      //   axios
      //     .post('http://127.0.0.1:8000/api/user-update-info', this.accountInfo, accessToken)
      //     .then((response) => {
