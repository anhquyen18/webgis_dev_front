<template>
  ...
  <a-drawer v-model:open="drawerVisible" title="Tìm kiếm đường đi" placement="left" :maskClosable="false" :mask="false">
    <div class="row w-100">
      <a-radio-group
    ...
    <div class="row mt-3">
      ...
      <div class="col-10 p-0"><a-input v-model:value="inputValue" placeholder="Chọn địa điểm" allowClear /></div>
      <div class="col-1 d-flex align-items-center justify-content-center">
